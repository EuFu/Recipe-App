...
(0,_views_js__WEBPACK_IMPORTED_MODULE_1__.renderIngredients)(ingredients);
(0,_views_js__WEBPACK_IMPORTED_MODULE_1__.renderSteps)(steps); // Event handler for return button
...
ingredientButton.addEventListener('click', function (e) {
  (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.newIngredient)();
}); // Trigger 'new ingredient' button with enter key

ingredientText.addEventListener('keyup', function (e) {
  if (e.keyCode === 13) {
    e.preventDefault();
...
document.querySelector('#help-button').addEventListener('click', function (e) {
  (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.removeHelp)();
}); // Add a new step

document.querySelector('#add-step').addEventListener('click', function (e) {
  (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.newStep)();
}); // Sort steps by number
...
document.querySelector('#delete-button').addEventListener('click', function (e) {
  (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.removeRecipe)(location.hash.substring(1));
  location.assign('/index.html');
