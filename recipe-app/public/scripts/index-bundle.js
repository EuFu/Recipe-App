...
/* harmony export */   "setDietType": () => (/* binding */ setDietType),
/* harmony export */   "getDietType": () => (/* binding */ getDietType)
/* harmony export */ });
var filters = {
  searchText: ''
};
...
var setDietType = function setDietType(diet) {
  dietType[diet.id] = !dietType[diet.id];
};

var getDietType = function getDietType() {
  return dietType;
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "saveRecipes": () => (/* binding */ saveRecipes),
/* harmony export */   "getRecipes": () => (/* binding */ getRecipes),
/* harmony export */   "createRecipe": () => (/* binding */ createRecipe),
/* harmony export */   "removeRecipe": () => (/* binding */ removeRecipe),
/* harmony export */   "toggleIngredient": () => (/* binding */ toggleIngredient),
/* harmony export */   "removeIngredient": () => (/* binding */ removeIngredient),
/* harmony export */   "removeStep": () => (/* binding */ removeStep),
/* harmony export */   "removeHelp": () => (/* binding */ removeHelp),
/* harmony export */   "toggleStep": () => (/* binding */ toggleStep),
/* harmony export */   "newIngredient": () => (/* binding */ newIngredient),
/* harmony export */   "sortByNumber": () => (/* binding */ sortByNumber),
/* harmony export */   "sameStepNum": () => (/* binding */ sameStepNum),
/* harmony export */   "newStep": () => (/* binding */ newStep)
/* harmony export */ });
...
var recipes = [];
var titleEl = document.querySelector('#recipe-name');
var dietEl = document.querySelector('#diet-type');
var ingredientButton = document.querySelector('#add-ingredient');
var ingredientText = document.querySelector('#new-ingredient');
var returnButton = document.querySelector("#return-home");
...
var ingredient = ingredients.find(function (ingredient) {
  return ingredient.id === recipe.ingredients.id;
});
var steps = recipe.steps;
titleEl.value = recipe.name;
dietEl.value = recipe.diet; // Read recipes from local storage
...
var saveRecipes = function saveRecipes() {
...
var newIngredient = function newIngredient() {
  var id = uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()();
  ...
  if (ingredientText.value.length > 0) {
    ...
    (0,_views_js__WEBPACK_IMPORTED_MODULE_1__.renderIngredients)(ingredients);
...
var removeIngredient = function removeIngredient(id) {
  var ingredientIndex = ingredients.findIndex(function (ingredient) {
    return ingredient.id === id;
  });
...
var removeHelp = function removeHelp() {
  var helpButton = document.querySelector('#help-button');
  var helpEl = document.querySelector('#help-area');
  ...
  (0,_views_js__WEBPACK_IMPORTED_MODULE_1__.renderSteps)(steps);
}; // Add a new step


var newStep = function newStep() {
  var directions = document.querySelector('#step-text');
  var id = uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()();
  ...
  if (directions.textContent.length > 0) {
    recipe.steps.push({
      ...
      text: "-   ".concat(directions.textContent)
    });
  }
...
var toggleStep = function toggleStep(id) {
...
var stepNumber = function stepNumber(steps) {
  if (steps.length > 0) {
    var numbersArray = [];
    steps.forEach(function (step) {
      return numbersArray.push(step.number);
    });
    return Math.max.apply(Math, numbersArray) + 1;
  } else {
    return 1;
  }
...
var sortByNumber = function sortByNumber(steps) {
  var lastNumber = steps[steps.length - 1].number;
  var duplicateNumber = steps.length !== new Set(steps.number).size;

  if (steps.length !== lastNumber || duplicateNumber) {
    steps.forEach(function (step) {
      return step.number = steps.indexOf(step) + 1;
    });
  }
...
var sameStepNum = function sameStepNum(num, oldNum) {
  var duplicateStep = steps.length !== new Set(steps.number).size;

  if (duplicateStep) {
    var spot = steps.splice(oldNum - 1, 1);
    steps.splice.apply(steps, [num - 1, 0].concat(_toConsumableArray(spot)));
  }
};
...
/* harmony export */   "renderIngredients": () => (/* binding */ renderIngredients),
/* harmony export */   "renderSteps": () => (/* binding */ renderSteps)
/* harmony export */ });
/* harmony import */ var _recipe_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./recipe.js */ "./src/recipe.js");
/* harmony import */ var _filters_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filters.js */ "./src/filters.js");

 // Generate DOM structure for the recipe

var generateRecipeDOM = function generateRecipeDOM(recipe) {
  ...
  statusEl.classList.add('recipe-status'); // Setup the recipe title
  ...
  recipeLink.appendChild(titleEl); // Setup the link

  recipeLink.setAttribute('href', "/edit.html#".concat(recipe.id)); // Setup the recipe status
...
var generateStatusMessage = function generateStatusMessage(recipe) {
  var status = recipe.ingredients.every(function (ingredient) {
...
var changeColor = function changeColor(dietType) {
  var mainColor = document.querySelector('#index-body');
  var moreThanOne = Object.values(dietType).filter(function (diet) {
    return diet;
  }).length > 1;
...
var renderRecipes = function renderRecipes() {
  var recipes = (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.getRecipes)();
  var filters = (0,_filters_js__WEBPACK_IMPORTED_MODULE_1__.getFilters)();
  var dietType = (0,_filters_js__WEBPACK_IMPORTED_MODULE_1__.getDietType)();
  var recipesEl = document.querySelector('#recipe-el');
  var filteredRecipes = recipes.filter(function (recipe) {
    return recipe.name.toLowerCase().includes(filters.searchText.toLowerCase());
  });
  var dietTypeArray = Object.keys(dietType).filter(function (key) {
    return dietType[key];
  });
  var filteredDietTypes = filteredRecipes.filter(function (recipe) {
    return dietTypeArray.includes(recipe.diet);
  });
  recipesEl.innerHTML = '';
  ...
  if (filteredRecipes.length > 0 && dietTypeArray.length === 0) {
    ...
    filteredDietTypes.forEach(function (recipe) {
      recipesEl.appendChild(generateRecipeDOM(recipe));
    });
  } else {
...
var generateIngredientsDOM = function generateIngredientsDOM(ingredient) {
  var ingredientEl = document.createElement('p');
  var checkbox = document.createElement('input');
  var ingredientName = document.createElement('text');
  var removeIngredientEl = document.createElement('button');
  checkbox.classList.add('checkbox-style');
  removeIngredientEl.classList.add('remove-style');
  ingredientEl.classList.add('single-step'); // Wire up the checkbox

  checkbox.setAttribute('type', 'checkbox');
  checkbox.checked = ingredient.possess;
  checkbox.addEventListener('change', function (e) {
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.toggleIngredient)(ingredient.id);
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.saveRecipes)();
    renderIngredients(ingredients);
  });
  ingredientEl.appendChild(checkbox); // Set the ingredient name

  ingredientName.textContent = ingredient.name;
  ingredientEl.appendChild(ingredientName); // Wire up the remove button

  removeIngredientEl.textContent = 'x';
  removeIngredientEl.addEventListener('click', function (e) {
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.removeIngredient)(ingredient.id);
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.saveRecipes)();
    renderIngredients(ingredients);
  });
...
var renderIngredients = function renderIngredients(ingredients) {
  ...
  var ingredientsName = document.querySelector('#new-ingredient');
...
var generateStepsDOM = function generateStepsDOM(step) {
  var stepEl = document.createElement('div');
  var individualStep = document.createElement('div');
  var stepCheckbox = document.createElement('input');
  ...
  removeButton.classList.add('remove-style'); // Setup the step completed checkbox

  stepCheckbox.setAttribute('type', 'checkbox');
  stepCheckbox.checked = step.completed;
  stepCheckbox.addEventListener('change', function (e) {
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.toggleStep)(step.id);
  ...
  individualStep.appendChild(stepText); // Setup the step number
  ...
  number.addEventListener('input', function (e) {
    if (!isNaN(e.target.value)) {
      ...
      (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.sameStepNum)(parseInt(e.target.value), oldNum);
      (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.sortByNumber)(steps);
      (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.saveRecipes)();
    }
  });
  individualStep.appendChild(number); // Setup directions element

  directions.textContent = step.text;
  individualStep.appendChild(directions); // Setup the remove step button

  removeButton.textContent = 'x';
  removeButton.addEventListener('click', function (e) {
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.removeStep)(step.id);
    (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.saveRecipes)();
    renderSteps(steps);
  });
...
var recipes = (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.getRecipes)();
(0,_views_js__WEBPACK_IMPORTED_MODULE_2__.renderRecipes)(); // Update Filters with input in Search bar

document.querySelector("#search").addEventListener('input', function (e) {
  (0,_filters_js__WEBPACK_IMPORTED_MODULE_1__.setFilters)(e.target.value);
  (0,_views_js__WEBPACK_IMPORTED_MODULE_2__.renderRecipes)();
}); // Update recipes when diet type selected

var checkboxes = document.querySelectorAll("input[type=checkbox][class=diet-select]");
var dietType = (0,_filters_js__WEBPACK_IMPORTED_MODULE_1__.getDietType)();
checkboxes.forEach(function (diet) {
  return diet.checked = dietType[diet.id];
});
checkboxes.forEach(function (diet) {
  return diet.addEventListener('change', function (e) {
    (0,_filters_js__WEBPACK_IMPORTED_MODULE_1__.setDietType)(diet);
    (0,_views_js__WEBPACK_IMPORTED_MODULE_2__.changeColor)(dietType);
    (0,_views_js__WEBPACK_IMPORTED_MODULE_2__.renderRecipes)();
  });
}); // Add a recipe with button click

document.querySelector('#add-button').addEventListener('click', function (e) {
  (0,_recipe_js__WEBPACK_IMPORTED_MODULE_0__.createRecipe)();
