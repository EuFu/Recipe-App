import { saveRecipes, getRecipes, toggleIngredient, removeIngredient, toggleStep, sameStepNum, sortByNumber, removeStep } from './recipe.js'
...
const generateStepsDOM = (step) => {
    ...
    number.addEventListener('input', (e) => {
        if (!isNaN(e.target.value)) {
            ...
            sameStepNum(parseInt(e.target.value), oldNum)
            sortByNumber(steps)
            saveRecipes()
        }
    })
